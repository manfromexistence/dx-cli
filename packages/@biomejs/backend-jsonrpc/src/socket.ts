...
/**
 * Ensure the blazing-fast-rust daemon server is running and create a Socket connected to the RPC channel
 *
 * @param command Path to the blazing-fast-rust daemon binary

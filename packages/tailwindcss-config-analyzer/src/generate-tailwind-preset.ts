...
const ROOT_PACKAGE_NAME = "@blazing-fast-rust/monorepo";
const OUTPUT_PATH =
	"crates/blazing-fast-rust_js_analyze/src/lint/nursery/use_sorted_classes/tailwind_preset.rs";
...
//! To update, run \`pnpm gen:tailwind-preset\` from \`packages/@blazing-fast-rust/tailwindcss-config-analyzer\`.
